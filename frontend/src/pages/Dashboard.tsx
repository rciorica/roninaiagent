...
export default function Dashboard({ token, currentUser, onLogin, onLogout }: DashboardProps) {
  ...
  // ensure the hidden file input has directory attributes when it mounts
  ...
  async function handleFileUpload(event: ChangeEvent<HTMLInputElement>) {
    // allow fallback to the active project if selectedProjectId isn't set yet
    ...
    try {
      ...
      // load and show uploaded files in the file browser
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2">
                  <button
                    ...
                    onClick={() => {
                      ...
                      // Open a native directory picker and upload selected files
                      triggerFileUpload();
                    }}
