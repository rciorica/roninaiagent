            ...
            <div className="mb-6 p-4 rounded-xl bg-red-50 border border-red-200 text-red-900 text-sm">
              ...
              {!userData?.userExists && (
                <button
                  ...
                  className="block mt-3 font-medium text-red-700 hover:text-red-900 underline"
                >
                  Create an account
                </button>
              )}
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-200">
                ...
                <div>
                  ...
                  {userData.rank && (
                    <p className="text-sm text-slate-600">{userData.rank.name}</p>
                  )}
                </div>
              </div>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  onClick={() => setStep(1)}
                  disabled={loading}
                  className="flex-1 rounded-xl border border-gray-300 px-4 py-3 text-slate-900 font-medium hover:bg-gray-50 disabled:bg-gray-100 transition"
                >
                  Back
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 rounded-xl bg-slate-900 px-4 py-3 text-white font-medium hover:bg-slate-700 disabled:bg-gray-400 transition"
                >
